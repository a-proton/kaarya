...
/* Component                                   */
/* ─────────────────────────────────────────── */
export default function EarningsViewClient() {
    ...
    try {
      ...
      if (payments.length === 0) {
        ...
        payments.forEach((payment, index) => {
          ...
          yPos += payment.transaction_id ? 42 : 36;

          if (payment.transaction_id) {
            doc.text(`Transaction ID: ${payment.transaction_id}`, 30, yPos - 6);
          }
      ...
      doc.save(
        `${project.project_name.replace(/\s+/g, "_")}_payment_report_${
